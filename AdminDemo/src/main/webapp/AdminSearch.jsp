...
<title>Search Member Details</title>
...
<nav>
	...
	<p class="inptp">Member Name</p> <input class="inpt" type="text" name="uid"><br><br>
		
			<p class="inptp">Member NIC</p> <input class="inpt" type="text" name="pass"><br><br>
			
		
		<button class="serch">Search Member</button>
	</form>
	<br><br><br><br><br><br><br><br><br>
<!--Footer-->
    <div className="ft">
