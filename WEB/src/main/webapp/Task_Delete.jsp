...
<title>Delete Admin Details | OSMS</title>
...
<div class="uplode-container">
		...
		<input class="uplode-input" type="text" name="title" value="<%= title %>" readonly />
		
		<label class="lable-uplode">Task Description</label>
		<input class="uplode-input" type="text" name="description" value="<%= description %>" readonly  />
		
		<label class="lable-uplode">Due Date </label>
		<input class="uplode-input" type="date" name="ddate"  value="<%= ddate %>" readonly />
